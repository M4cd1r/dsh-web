...
export const zh = {
  ...
  'usage.sidebar.label': '用量',
  'usage.sidebar.expand': '展开用量面板',
  'usage.sidebar.collapse': '收起用量面板',
  'usage.sidebar.unavailable': '用量服务未启用（请检查 dsh-usage 插件与「启用插件」开关）',
  ...
  'usage.config.sidebarPanel': '显示侧边栏用量',
...
export const en: Record<UsageKey, string> = {
  ...
  'usage.sidebar.label': 'Usage',
  'usage.sidebar.expand': 'Expand usage panel',
  'usage.sidebar.collapse': 'Collapse usage panel',
  'usage.sidebar.unavailable': 'Usage service unavailable (check the dsh-usage plugin and the "Enable plugin" toggle)',
  ...
  'usage.config.sidebarPanel': 'Show usage in sidebar',
