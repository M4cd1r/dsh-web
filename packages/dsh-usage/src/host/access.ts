/**
 * Usage trust fence: loopback (the desktop) always passes; a live
 ...
 * pair-access.ts copy (shared by git-graph / pet / skill-explorer / usage).
 */
...
/**
 * Whether this request may enter any /api/dsh-usage route.
