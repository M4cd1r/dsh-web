...
export const ru: Record<string, string> = {
  ...
  'usage.config.sidebarPanel': 'Показывать использование в боковой панели',
  ...
  'usage.sidebar.collapse': 'Свернуть панель использования',
  'usage.sidebar.expand': 'Развернуть панель использования',
  'usage.sidebar.label': 'Использование',
  'usage.sidebar.unavailable': 'Сервис использования недоступен (проверьте плагин dsh-usage и переключатель «Включить плагин»)',
